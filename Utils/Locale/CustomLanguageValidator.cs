namespace PRN211_ShoesStore.Utils.Locale
{
    public class CustomLanguageValidator : FluentValidation.Resources.LanguageManager
    {
        ...
        public CustomLanguageValidator()
        {
            ...
            AddTranslation("en", MessageKey.MESSAGE_BLOCK_USER,
                "Thank you for your request, we will consider your case as soon as posbile and reply the result via your email");
            ...
            AddTranslation("en", ErrorMessageKey.ERROR_DISSABLED_ACCOUNT,
            ...
            AddTranslation("en", ErrorMessageKey.ERROR_PASSWORD_CONTAIN_CHARACTER,
                "should contain at least 1 uppercase, 1 lowercase, 1 number");
            ...
            AddTranslation("vi", ErrorMessageKey.ERROR_DISSABLED_ACCOUNT,
                "tài khoản của bạn đã bị vô hiệu hóa, nếu bạn có vấn đề muốn phản hồi, xin hãy liên lạc");
            ...
            AddTranslation("vi", ErrorMessageKey.ERROR_PASSWORD_CONTAIN_CHARACTER,
                "phải có ít nhất 1 kí tự hoa, 1 kí tự thường, 1 số");
